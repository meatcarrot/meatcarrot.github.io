    ...
    <div className="mt-6 rounded-xl border border-border bg-subtle/35 p-5">
      <div className="grid grid-cols-[1fr_72px_1fr] items-center gap-3">
        <div className="rounded-xl border border-border bg-surface p-4">
          ...
          <div className="mt-2 text-[10px] leading-relaxed text-muted">시계열 입력 데이터</div>
        </div>

        <div className="flex flex-col items-center">
          <ArrowRight size={15} className="text-muted" />
          <div className="mt-2 rounded-lg bg-[#f1ecfb] px-2.5 py-2 text-center text-[10px] font-semibold text-[#7355b7]">
            Extreme?
          </div>
        ...
        <div className="space-y-2">
          <div className="rounded-lg bg-[#eaf7ee] px-3 py-2.5">
            <div className="text-[10px] font-semibold text-[#2f8f55]">Normal Regressor</div>
            <div className="mt-0.5 text-[9px] text-muted">평상시 모델</div>
          </div>
          <div className="rounded-lg bg-[#fff4dc] px-3 py-2.5">
            <div className="text-[10px] font-semibold text-[#9a6b14]">Extreme Regressor</div>
            <div className="mt-0.5 text-[9px] text-muted">재난 모델</div>
          </div>
        </div>
      </div>

      <div className="mt-4 flex items-center gap-3 border-t border-border pt-4 text-[11px]">
...
function LLMVisual() {
  ...
  return (
    <div className="mt-6 rounded-xl border border-border bg-subtle/35 p-5">
          ...
          return (
            <div key={step.label} className="contents">
              <div className="text-center">
                ...
                <div className="mt-2 text-[11px] font-semibold text-foreground">{step.label}</div>
      ...
      <div className="mt-4 border-t border-border pt-4 text-[11px] text-muted">
        실제 컴파일·실행 기반 QA 루프
      </div>
    </div>
  )
